...
test checkCalibration {
    ...
    try expectEqual(null, try checkCalibration(allocator, parsed[3]));
    try expectEqual(null, try checkCalibration(allocator, parsed[4]));
    try expectEqual(null, try checkCalibration(allocator, parsed[5]));
    try expectEqual(null, try checkCalibration(allocator, parsed[6]));
